package it.pagopa.interop.be.authorizationmanagement.model.persistence.key

import cats.implicits.toTraverseOps
import it.pagopa.interop.be.authorizationmanagement.errors.KeyManagementErrors.ThumbprintCalculationError
import it.pagopa.interop.be.authorizationmanagement.model.persistence.{Keys, Persistent, ValidKey}
import it.pagopa.interop.be.authorizationmanagement.model.{ClientKey, KeysResponse}
import it.pagopa.interop.be.authorizationmanagement.service.impl.KeyProcessor
