package it.pagopa.interop.be.authorizationmanagement.server.impl
...
import it.pagopa.interop.be.authorizationmanagement.api.impl.{
...
import it.pagopa.interop.be.authorizationmanagement.common.system.{ApplicationConfiguration, shardingSettings}
import it.pagopa.interop.be.authorizationmanagement.model.persistence.{
  Command,
